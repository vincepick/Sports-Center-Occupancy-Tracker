...
model = tf.keras.models.load_model('models/septseventhMinMaxScaler.keras')
...
# Convert the predicted value back to percentage
    ...
    print(f"Predicted occupancy percentage at {hour: 02d}:00: {predicted_occupancy_percentage:.2f}%")